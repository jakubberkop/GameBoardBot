...
#     state_dim: int = state_size  # size of state space
#     act_dim: int = action_size  # size of action space
...
#         self.act_dim = len(dataset[0]["actions"])
#         self.state_dim = len(dataset[0]["states"])
